      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            In the hustle and bustle of daily life, finding time for self-care can be a challenge. That's why we've designed our Quick Facial, a speedy yet luxurious treatment that revitalizes your skin in just 45 minutes. 
            </p>
