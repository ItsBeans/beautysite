      ...
      <Header/>
        <div className=" place-content-center mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Unlock the secret to radiant, healthy skin with our Personalized Facial. Whether you’re combating dryness, acne, aging, or simply want to maintain your glow, our expert beauty therapists will create a custom treatment plan just for you.
            </p>
