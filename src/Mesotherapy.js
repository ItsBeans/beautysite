      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Transform your skin with our Mesotherapy treatment, a revolutionary technique that delivers vitamins, minerals, and amino acids directly into your skin. This non-surgical procedure revitalizes and hydrates your skin from within, addressing concerns like fine lines, pigmentation, and dullness.
            </p>
            <ul class=" text-left py-12">
              ...
              <li><span class="font-bold">Mesotherapy Injection:</span> To deliver vitamins and other helpful ingredients into the skin.</li>
              <li><span class="font-bold">Serum Application:</span> To enhance the mesotherapy results and soothe the skin.</li>
