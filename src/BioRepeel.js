      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Reveal a fresher, more radiant you with our BioRePeel treatment. This advanced, no-peel chemical peel rejuvenates your skin by promoting cell turnover and boosting collagen production. 
            </p>
            <ul class=" text-left py-12 ">
              ...
              <li><span class="font-bold">BioRepeel -</span> A specialized solution is applied to promote skin renewal and enhance texture.</li>
              <li><span class="font-bold">Neutralization -</span> Ensures the skin is balanced and comfortable after the BioRepeel treatment.</li>
