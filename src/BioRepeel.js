        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <ul class=" text-left py-12 ">
              ...
              <li><span class="font-bold">BioRepeel:</span> Apply the BioRepeel solution.</li>
              <li><span class="font-bold">Neutralization:</span>  To ensure the skin is balanced and comfortable.</li>
