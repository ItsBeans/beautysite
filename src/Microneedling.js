      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Unlock the secret to youthful, glowing skin with our Microneedling treatment. This innovative procedure stimulates your skin's natural healing process, boosting collagen and elastin production. Perfect for reducing fine lines, acne scars, and improving overall skin texture, Microneedling offers a radiant and rejuvenated complexion.
            </p>
            <ul class=" text-left py-12">
              ...
              <li><span class="font-bold">Microneedling:</span> To stimulate collagen production and improve skin texture, tone, and firmness.</li>
              <li><span class="font-bold">Serum Application:</span> To enhance the microneedling results and soothe the skin.</li>
