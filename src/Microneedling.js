      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Discover the key to youthful, radiant skin with our Microneedling treatment. This cutting-edge procedure stimulates your skin's natural healing process, promoting increased collagen and elastin production. Ideal for minimizing fine lines, reducing the appearance of acne scars, and enhancing overall skin texture, Microneedling delivers a rejuvenated complexion that glows with vitality.
            </p>
            <ul class=" text-left py-12">
              ...
              <li><span class="font-bold">Microneedling -</span> Stimulates collagen production, improving skin texture, tone, and firmness.</li>
              <li><span class="font-bold">Serum Application -</span> Enhances the microneedling results and soothe the skin.</li>
